...
"""Search for XorDiff characteristics of round-based functions over multiple number of rounds.
...
iterator = round_based_ch_search(Belt, 2, 30, XorDiff, assert_type, "btor",
