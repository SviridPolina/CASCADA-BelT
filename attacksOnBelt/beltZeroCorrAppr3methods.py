...
"""Search for LinearMask universally-invalid Characteristic of round-based functions over multiple number of rounds.
...
wrapped_ch_model = get_wrapped_chmodel(EncryptionChModel(Belt, LinearMask))
...
ch_model_E = EncryptionChModel(Belt, LinearMask)
